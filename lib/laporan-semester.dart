...
import './laporan-semester-detail.dart';

class LaporanSemester extends StatefulWidget {
  _LaporanSemesterState createState() => _LaporanSemesterState();
}

class _LaporanSemesterState extends State<LaporanSemester> {
  List data = [];
  bool loading = false;
                  ...
                  return ListTile(
                    ...
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => LaporanSemesterDetail(nim: d['nim'], nama: d['nama'])
                      ));
                    },
                    title: Text(d['nama']),
